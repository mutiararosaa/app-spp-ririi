...
?>
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Transaksi Pembayaran SPP</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group input-group">
                                            <button type="submit" name="proses" class="btn btn-outline btn-success"
                                                Value="Proses">Proses Pembayaran</button>
                                            <a href="<?php echo site_url();?>pembayaran/"
                                                class="btn btn-outline btn-danger">Reset Data</a>
                                        </div>
