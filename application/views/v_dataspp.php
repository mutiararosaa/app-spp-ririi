                            ...
                            <div class="dataTable_wrapper">
								...
								?>
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="<?php echo site_url('dataspp/formedit/' . $d['id_spp']); ?>" class="btn btn-success"  onclick="return confirm('Data ini akan diubah?') ">EDIT</a>
                                            <a href="<?php echo site_url('dataspp/hapus/' . $d['id_spp']); ?>" class="btn btn-danger"  onclick="return confirm('Data ini akan dihapus?') ">HAPUS</a>
                                            </td>
                                        </tr>
                                        <?php
									$no++;
