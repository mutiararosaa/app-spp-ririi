...
<body style ="font-family:georgia,garamond,serif !important;">
    ...
    <div id="wrapper" style="background : #0f6949;">
        ...
        <div id="page-wrapper" style="background:#abd6c7;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dashboard Aplikasi Spp</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background:#5da698;">
                            <div class="row">
                                <div class="col-xs-3">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background:#d4b6d4;">
                            <div class="row">
                                <div class="col-xs-3">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background:#869bb3;">
                            <div class="row">
                                <div class="col-xs-3">
