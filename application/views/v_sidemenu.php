<div class="navbar-default sidebar" style="background: #0f6949;" role="navigation">
...
?>
<li>
    <img src ="<?php echo base_url();?>images/logospp.png" width ="100%" alt = "logo">
</li>
<li>
...
<li>
    <img src ="<?php echo base_url();?>images/logospp.png" width ="100%" alt = "logo">
            ...
            <li>
                <a href="<?php echo base_url();?>pembayaran/"><i class="fa fa-edit fa-fw"></i> Entri Trans.
                    Pembayaran</a>
            </li>
            <?php
	}
