                            ...
                            <div class="dataTable_wrapper">
								...
								?>
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="<?php echo site_url('datakelas/formedit/' . $d['id_kelas']); ?>" class="btn btn-success"  onclick="return confirm('Data ini akan diubah?') ">EDIT</a>
                                            <a href="<?php echo site_url('datakelas/hapus/' . $d['id_kelas']); ?>" class="btn btn-danger"  onclick="return confirm('Data ini akan dihapus?') ">HAPUS</a>
