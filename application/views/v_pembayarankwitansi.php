...
<body  style ="background-color: #809fff; font-family:georgia,garamond,serif !important;">
    <header class="clearfix">
        <div id="logo">
            <img src="<?php echo base_url();?>invoice/logospp.png">
        </div>
        ...
        <div id="project">
            <div>NISN / NIS : <?php echo $rkwitansi['nisn'];?> / <?php echo $rkwitansi['nis'];?></div>
            <div>NAMA SISWA : <?php echo $rkwitansi['nama'];?></div>
            <div>KELAS : <?php echo $rkwitansi['nama_kelas'];?></div>
            <div>KOMPETENSI KEAHLIAN : <?php echo $rkwitansi['kompetensi_keahlian'];?></div>
            <div>
                TANGGAL PEMBAYARAN : <?php echo $tgl; ?>
            </div>
            <div>
                NAMA PETUGAS : <?php echo $rkwitansi['nama_petugas'];?></div>
        </div>
    </header>
    <main>
        <table>
        ...
        <div id="notices">
            <div>NOTICE:</div>
            <div class="notice">Bukti pembayaran harap disimpan dengan baik.</div>
        </div>
    </main>
</body>
