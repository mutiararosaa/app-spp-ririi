                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="post">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Nama Kelas" name="namakelas"
                                                type="text" value="<?php echo $satu['nama_kelas'];?>">
                                            <?php echo form_error('namakelas','<p class="text-danger">','</p>'); ?>
                                            <?php }
											?>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Kompetensi Keahlian" name="komli"
                                                type="text">
                                            <?php echo form_error('komli','<p class="text-danger">','</p>'); ?>
                                            <?php }
											else{ ?>
                                            <input class="form-control" placeholder="Kompetensi Keahlian" name="komli"
                                                type="text" value="<?php echo $satu['kompetensi_keahlian'];?>">
                                            <?php echo form_error('komli','<p class="text-danger">','</p>'); ?>
                                            <?php }
											?>
                                        </div>
